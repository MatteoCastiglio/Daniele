...
public class FinalServer implements Runnable {
	...
	public static final String data_dir = "finalData";
	...
	public FinalServer(int timeout, int cacheSize, int numErrors, int repeated, int game, boolean gui) {
		this.gameC = game;
		this.enableGui = gui;
		this.time = timeout;
	...
	public static void main(String[] args) {
		...
		// Start the server
		FinalServer engine = new FinalServer(time, moveCache, errors, repeated, gameChosen, enableGui);
		engine.run();
	}
